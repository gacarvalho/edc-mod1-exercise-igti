...
enemnovo = (
    ...
    .load("s3://datalake-sesson-edc-tf/staging-zone/enem")
)
...
enemnovo = enemnovo.withColumn("NO_MUNICIPIO_RESIDENCIA", lit(
    "NOVA CIDADE")).withColumn("CO_MUNICIPIO_RESIDENCIA", lit(10000000))


logger.info("Pega os dados do Enem velhos na tabela Delta...")
enemvelho = DeltaTable.forPath(
    spark, "s3://datalake-sesson-edc-tf/staging-zone/enem")
